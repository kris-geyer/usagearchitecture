...
public class notificationLogging extends NotificationListenerService {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if(researcherInput.USAGE_STATISTICS_REQUIRED){
            initializeHandler();
            initializeForegroundReceivers();
        }else{
            initializeBasicReceivers();
        }
    ...
    private void initializeForegroundReceivers() {
    ...
    private void initializeBasicReceivers() {
